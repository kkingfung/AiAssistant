...
namespace AiAssistant
{
    ...
    /// <summary>
    /// ²�ƪ� ViewModel�A�ܽd�D�P�B�I�s IAiService�]������ UI�^�ä䴩��y�P�����C
    /// �i�����]�w�� Window.DataContext�C
    /// </summary>
    public sealed class AssistantViewModel : INotifyPropertyChanged
    {
        ...
        // �D�P�B�@���ʦ^���]UI thread-safe: await will resume on UI context�^
